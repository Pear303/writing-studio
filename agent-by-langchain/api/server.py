...
from api.routes import chat, history, tokens, skills, memory, todo, pipeline, vibe_settings, novel_import
...
app.include_router(novel_import.router, prefix="/api/novel-import", tags=["novel-import"])
